...
function RegisterDosen() {
    ...
    const takeRegisterDosen = async (e) => {
        e.preventDefault();
        try {
          const dosenData = {
            BNID: bnid,
          ...
          const response = await axios.post(
            'http://localhost:3000/api/dosens/registerdosen',
            dosenData,
            {
              headers: {
  ...
  return (
    <div className='d-flex justify-content-center align-items-center bg-primary vh-100'>
        <div className='bg-white p-3 rounded w-50' id="maincontainer">
            <p className='d-flex justify-content-center'>Dosen Registration</p>
            <form onSubmit={takeRegisterDosen}>
